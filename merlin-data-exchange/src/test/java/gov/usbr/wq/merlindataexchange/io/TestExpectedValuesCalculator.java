...
final class TestExpectedValuesCalculator
{
    ...
    void testCalculateBothOnInterval()
    {
        ...
        int expectedNumValues = ExpectedNumberValuesCalculator.getExpectedNumValues(start, end, "1Day", timeZone, mockFirstTime, mockLastTime);
        ...
        expectedNumValues = ExpectedNumberValuesCalculator.getExpectedNumValues(start, end, "1Day", timeZone, mockFirstTime, mockLastTime);
        ...
        expectedNumValues = ExpectedNumberValuesCalculator.getExpectedNumValues(start, end, "1Hour", timeZone, mockFirstTime, mockLastTime);
